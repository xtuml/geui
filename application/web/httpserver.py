...
class LogMiddleware:
    ...
    def __call__(self, environ, start_response):
        def xstart_response(print_log, status, response_headers, *args):            # added print_log parameter to control when
            out = start_response(status, response_headers, *args)                   # requests were logged
            if print_log:                                                           # <-- my code -- Levi Starrett
