    ...
    def wsgifunc(self, *middleware):
        ...
        def wsgi(env, start_resp):
            ...
            try:
                ...
                ########################
                if result == 'NoLog':           # <-- my code -- Levi Starrett
                    print_log = False           # If the command request is made and there
                    result = None
                else:                           # is no command, then the request is not
                    print_log = True            # logged.
                ########################
            ...
            start_resp(print_log, status, headers)  #<--- added and extra argument to control when requests are logged -- Levi Starrett
